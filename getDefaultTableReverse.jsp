...
String toPrintTable = "<table id = \"exampleR\"  class=\"display compact\" cellspacing=\"0\" width=\"100%\" >" + "<thead><tr>";
...
toPrintAHref += "<a href=\"javascript:void(0);\" class=\"LinkButton\"" + "onclick=\"fnShowHide(0);\"" + ">Toggle Server<br></a>";
	...
	System.out.println("3");
		...
		for (Map.Entry<String, String> en : factsMap.entrySet()) {
			
			String tmpFact = en.getKey().toString();
			toPrintTable += "<tr><td>" + tmpFact + "</td>";
			for (Map.Entry<String, String> entry : serverMap.entrySet()) {
				
				String tdVal = "None";
				String tmpServer = entry.getKey().toString();
	...
	for (Map.Entry<String, String> entry : serverMap.entrySet()) {
		String tmpServer = entry.getKey().toString();
		counter++;
		toPrintAHref += "<li><a href=\"javascript:void(0);\" class=\"LinkButton\" " + "onclick=\"fnShowHide(" + counter + ");\"" + ">Toggle " + tmpServer +"<br></a> - " ;  
