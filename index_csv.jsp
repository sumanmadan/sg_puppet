...
{
    document.getElementById('tabs').style.height = window.innerHeight +'px';
}
...
<div id="tabs" style="width:100%;padding-bottom:20px;">
  <ul>
 ...
 <div id = "tabs-6"> 
	<div id = "dtreeR" style="float: left; width: 25%; class="ui-widget-content"></div>
