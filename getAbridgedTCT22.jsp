...
String lastLoadDateSql = "select max(load_date) as load_date from puppet_mast where lower(nodename) like 'tct22%' ";
infoSql = "select * from puppet_mast where factname in ( 'ipaddress' , 'serialnumber',  'productname', 'specs_fa_version', 'framework_version', 'util_version', 'prober_ip_nic1' ,'hp4070_version' ) "+ 
	      " and  lower(nodename) like 'tct22%'   ";
...
toPrintTable += "<table id = \"tct22\"  class=\"display compact\" cellspacing=\"0\" width=\"100%\" >" + "<thead><tr>";
...
toPrintAHref += "<a href=\"javascript:void(0);\" class=\"LinkButton\"" + "onclick=\"fnShowHide(0);\"" + ">Toggle Server<br></a>";
	...
	System.out.println("3");
		...
		for (Map.Entry<String, String> en : serverMap.entrySet()) {
			...
			if ( tmpServer.startsWith("tct22") || tmpServer.startsWith("TCT22") ) {
				//toPrintTable += "<td>" + 93000 + "</td>";
				toPrintTable += "<td style='background-color:"  +  "#DBF0F7" +  "'>" + "UltraFlex" + "</td>";  
			}
