...
infoSql =  "select * from puppet_mast where factname in ( 'ipaddress' , 'serialnumber', 'prober_driver_version' , 'productname', 'specs_fa_version', 'framework_version', 'util_version', 'prober_ip_nic1' ,'hp4070_version'," +
		   " 'prober_driver' , 'vgem' , 'csv_formatter', 'smart_test_version' ) "  +
	      " and  lower(nodename) like 'tct21%' order by factname asc  ";
...
toPrintAHref += "<a href=\"javascript:void(0);\" class=\"LinkButton\"" + "onclick=\"fnShowHide(0);\"" + ">Toggle Server<br></a>";
	try{
		...
		while( rs.next() ){
		      ...
		      if ( fact.equalsIgnoreCase("ipaddress")  || fact.equalsIgnoreCase("prober_ip_nic1") || fact.equalsIgnoreCase("serialnumber")) {
		    	 toColorFlag = "No";
		      } else {
		    	 toColorFlag = "Yes";
		      }
